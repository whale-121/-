...
public class test {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < titleList.size(); i++) {
			...
			a = dao.newTitle(titleList.get(i));
		}
		
		System.out.println(titleList.size());
		System.out.println(a);
		for (int i = 0; i < titleList.size(); i++) {
			System.out.print(titleList.get(i).getGenre());
			System.out.print(titleList.get(i).getCondition());
			System.out.print(titleList.get(i).getTitle());
			System.out.print(titleList.get(i).getMem_id());
			System.out.println("");
		}
